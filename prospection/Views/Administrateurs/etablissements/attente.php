	...
	<body style='margin-left:170px'>
		...
		<section>
			...
			<nav id="navigation_etablissements" style='background-color: #F2F2F2;'>
				<a href="?view=accueil_admin&pre=attente" style='color:black; text-decoration:none;' id="prospection2"><div><strong>PROSPECTION</strong></div></a>
				<a href="?view=attente&pre=attente" style='color:black; text-decoration:none;' id="attente2"><div><strong>EN ATTENTE</strong></div></a>
				<a href="?view=noForum&pre=attente" style='color:black; text-decoration:none;' id="noForum2"><div><strong>PAS DE FORUM</strong></div></a>
			</nav>
			    ...
			    echo "<script type='text/javascript'>
                        $(function() {
                            $('#searchCampus').click(function() {
                                ...
                                window.location.href ='?view=attente&pre=attente&campus=' + campusChoice + '&filtre=' + filtreChoice + '&ordre=' + ordreChoice;
                            });
                        });
                      </script>";
			?>
			...
			<table>
				...
				<?php
				  ...
				  echo "<tr>";
					  echo "<td><a href='?view=fiche_lycees&pre=attente&id=$forum[0]'>$forum[13]</a></td>
							<td><a href='?view=fiche_lycees&pre=attente&id=$forum[0]'>$forum[14]</a></td>
							<td><a href='?view=fiche_lycees&pre=attente&id=$forum[0]'>$forum[15]</a></td>
							<td><a href='?view=fiche_lycees&pre=attente&id=$forum[0]'>$forum[17]</a></td>
							<td><a href='?view=fiche_lycees&pre=attente&id=$forum[0]'>$forum[18]</a></td>
						</tr>";
					}
				?>
			</table>
