	...
	<body style='margin-left:170px'>
		...
		<section>
			...
			<nav id="navigation_etablissements" style='background-color: #F2F2F2;'>
				<a href="?view=accueil_admin&pre=accueil_admin" style='color:black; text-decoration:none;' id="prospection1"><div><strong>PROSPECTION</strong></div></a>
				<a href="?view=attente&pre=accueil_admin" style='color:black; text-decoration:none;' id="attente1"><div><strong>EN ATTENTE</strong></div></a>
				<a href="?view=noForum&pre=accueil_admin" style='color:black; text-decoration:none;' id="noForum1"><div><strong>PAS DE FORUM</strong></div></a>
			</nav>
			    ...
			    echo "<script type='text/javascript'>
                        $(function() {
                            $('#searchCampus').click(function() {
                                ...
                                window.location.href ='?view=accueil_admin&pre=accueil_admin&campus=' + campusChoice + '&filtre=' + filtreChoice + '&ordre=' + ordreChoice;
                            });
                        });
                      </script>";
			?>
				...
				<?php
					foreach ($forums as $forum){
		                ...
		                if ((($filtre == "Samedi") && ($jour == "Samedi")) || ($filtre != "Samedi")) {
						  ...
						  echo "<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$jour</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$tabDate[2]/$tabDate[1]/$tabDate[0]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[3]-$forum[4]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[8]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[13]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[14]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[15]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[17]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$forum[18]</a></td>
								<td><a href='?view=fiche_lycees&pre=accueil_admin&id=$forum[0]'>$places</a></td>
							</tr>";
						}
					}
				?>
