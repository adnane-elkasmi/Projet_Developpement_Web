	...
	<body style='margin-left:170px'>
		...
		<section>
			...
			<nav id="navigation_etablissements" style='background-color: #F2F2F2;'>
				<a href="?view=accueil_eleves&pre=noForum_eleves" style='color:black; text-decoration:none;' id="prospection3"><div><strong>PROSPECTION</strong></div></a>
				<a href="?view=attente_eleves&pre=noForum_eleves" style='color:black; text-decoration:none;' id="attente3"><div><strong>EN ATTENTE</strong></div></a>
				<a href="?view=noForum_eleves&pre=noForum_eleves" style='color:black; text-decoration:none;' id="noForum3"><div><strong>PAS DE FORUM</strong></div></a>
			</nav>
			    ...
			    echo "<script type='text/javascript'>
                        $(function() {
                            $('#searchCampus').click(function() {
                                ...
                                window.location.href ='?view=noForum_eleves&pre=noForum_eleves&filtre=' + filtreChoice + '&ordre=' + ordreChoice;
                            });
                        });
                      </script>";
			?>
